"""百度千帆 provider — OpenAI-compatible API"""
...
class QianfanProvider(LLMProvider):
    """百度千帆 LLM Provider (OpenAI-compatible)"""

    def __init__(self, api_key=None, model=None, base_url=None, **kwargs):
        self.api_key = api_key or os.getenv("QIANFAN_API_KEY")
        self.base_url = base_url or os.getenv("QIANFAN_BASE_URL", "https://qianfan.baidubce.com/v2")
        self.model = model or os.getenv("QIANFAN_MODEL", "ernie-4.0-turbo-8k")
