"""小米 provider — OpenAI-compatible API"""
...
class XiaomiProvider(LLMProvider):
    """小米 LLM Provider (OpenAI-compatible)"""

    def __init__(self, api_key=None, model=None, base_url=None, **kwargs):
        self.api_key = api_key or os.getenv("XIAOMI_API_KEY")
        self.base_url = base_url or os.getenv("XIAOMI_BASE_URL", "https://api.xiaomimlm.com/v1")
        self.model = model or os.getenv("XIAOMI_MODEL", "milm-6b")
