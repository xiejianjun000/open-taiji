"""腾讯混元 provider — OpenAI-compatible API"""
...
class HunyuanProvider(LLMProvider):
    """腾讯混元 LLM Provider (OpenAI-compatible)"""

    def __init__(self, api_key=None, model=None, base_url=None, **kwargs):
        self.api_key = api_key or os.getenv("HUNYUAN_API_KEY")
        self.base_url = base_url or os.getenv("HUNYUAN_BASE_URL", "https://api.hunyuan.cloud.tencent.com/v1")
